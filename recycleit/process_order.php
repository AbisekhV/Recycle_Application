	...
	<div class="container-fluid">	
		<div class='row'>
			...
			?>
				<div class="container">
					<div class="jumbotron">
						<h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span>  Recycle Done Successfully.</h1>
					</div>
				</div>
				<br>
				<h2 class="text-center"> Thank you for Recycling! The Recycling process is now complete.</h2>
				
				<h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo $_GET['order']; ?></span> </h3>
				
				<h3 class="text-center">Thank You for Using <a href="item.php">Recycle Zone!</a></h3>
			<?php } else { ?>
				<h3 class="text-center">Thank You for Using <a href="item.php">Recycle Zone!</a></h3>
			<?php } ?>	 
		</div>	  
