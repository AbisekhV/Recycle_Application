...
<div class="content">
	<div class="container-fluid">		
		...
		?>      
			...
			<?php
			echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Empty Cart</button></a>&nbsp;<a href="item.php"><button class="btn btn-warning">Add more items</button></a>&nbsp;<a href="checkout.php"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Check Out</button></a>';
			?>
		<?php
		...
		?>
			<div class="container">
			<div class="jumbotron">
			<h3>Your cart is empty. Choose from the  <a href="item.php">Recycle Items</a> here.</h3>        
			</div>      
			</div>    
		<?php
		}
